...
Our model grid is created with a call to \code{model\_grid.RasterModelGrid()}, which returns a raster model grid object with the given dimensions and node spacing. %We then set up this grid with a call to its \code{initialize} method, passing it the desired grid dimensions and spacing.
...
\lstinputlisting[firstnumber=64,firstline=64,lastline=68]{diffusion_with_model_grid.py}
...
\lstinputlisting[firstnumber=73,firstline=73,lastline=93]{diffusion_with_model_grid.py}
...
\lstinputlisting[firstnumber=96,firstline=96,lastline=97]{diffusion_with_model_grid.py}
...
\lstinputlisting[firstnumber=1,firstline=1,lastline=193]{overland_flow_with_model_grid_dem.py}
...
\lstinputlisting[firstnumber=138,firstline=138,lastline=138]{overland_flow_with_model_grid_dem.py}
...
\lstinputlisting[firstnumber=143,firstline=143,lastline=145]{overland_flow_with_model_grid_dem.py}
...
\lstinputlisting[firstnumber=24,firstline=24,lastline=26]{diffusion_with_radial_model_grid.py}
...
\lstinputlisting[firstnumber=35,firstline=35,lastline=36]{diffusion_with_radial_model_grid.py}
...
\lstinputlisting[firstnumber=74,firstline=74,lastline=89]{diffusion_with_radial_model_grid.py}
