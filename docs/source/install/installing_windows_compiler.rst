...
[[ here | Installing-Landlab-with-Anaconda#now-to-install-landlab ]], you don't
need to do this.
...
install! Follow the [[ main instructions | Installing-Landlab-from-source-code-("developer-install") ]]
