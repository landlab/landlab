...
def test_create():
    ...
    assert_equal(graph.number_of_nodes, 5)
    assert_equal(graph.number_of_links, 8)
...
def test_spacing():
    ...
    assert_array_almost_equal(graph.xy_of_node,
                              [[ 0., -1.],
                               [-1.,  0.], [ 0.,  0.], [ 1.,  0.],
                               [ 0.,  1.]])

    assert_array_almost_equal(graph.xy_of_corner,
                              [[-0.5, -0.5], [ 0.5, -0.5],
                               [-0.5,  0.5], [ 0.5,  0.5]])
...
def test_faces_at_corner():
    ...
    assert_array_equal(graph.faces_at_corner,
                       [[0, 1], [2, 0], [3, 1], [3, 2]])
    assert_array_equal(graph.links_at_node,
                      [[2, 1, 0, -1],
                       [3, 5, 0, -1], [4, 6, 3, 1], [7, 4, 2, -1],
                       [5, 6, 7, -1]])
