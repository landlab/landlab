...
def grid_flat():
    ...
    grid_flat.add_field(
        "node", "topographic__elevation", np.ones(grid_flat.number_of_nodes)
    )
...
def grid_east():
    ...
    grid_east.add_field("node", "topographic__elevation", grid_east.node_x * -S + 1.2)
...
def grid_north():
    ...
    grid_north.add_field("node", "topographic__elevation", grid_north.node_y * -S + 1.2)
...
def grid_west():
    ...
    grid_west.add_field("node", "topographic__elevation", grid_west.node_x * S)
...
def grid_south():
    ...
    grid_south.add_field("node", "topographic__elevation", grid_south.node_y * S)
...
def grid_ne():
    ...
    grid_ne.add_field(
        "node", "topographic__elevation", (grid_ne.node_y + grid_ne.node_x) * -S
    )
...
def grid_nw():
    ...
    grid_nw.add_field(
        "node", "topographic__elevation", (grid_nw.node_x - grid_nw.node_y) * S
    )
...
def grid_sw():
    ...
    grid_sw.add_field(
        "node", "topographic__elevation", (grid_sw.node_x + grid_sw.node_y) * S
    )
...
def grid_se():
    ...
    grid_se.add_field(
        "node", "topographic__elevation", (grid_se.node_y - grid_se.node_x) * S
    )
...
def grid_ene():
    ...
    grid_ene.add_field(
        "node", "topographic__elevation", (grid_ene.node_y + 2 * grid_ene.node_x) * -S
    )
...
def grid_nne():
    ...
    grid_nne.add_field(
        "node", "topographic__elevation", (2 * grid_nne.node_y + grid_nne.node_x) * -S
    )
...
def grid_nnw():
    ...
    grid_nnw.add_field(
        "node", "topographic__elevation", (grid_nnw.node_x - 2 * grid_nnw.node_y) * S
    )
...
def grid_wnw():
    ...
    grid_wnw.add_field(
        "node", "topographic__elevation", (2 * grid_wnw.node_x - grid_wnw.node_y) * S
    )
...
def grid_wsw():
    ...
    grid_wsw.add_field(
        "node", "topographic__elevation", (2 * grid_wsw.node_x + grid_wsw.node_y) * S
    )
...
def grid_ssw():
    ...
    grid_ssw.add_field(
        "node", "topographic__elevation", (grid_ssw.node_x + 2 * grid_ssw.node_y) * S
    )
...
def grid_sse():
    ...
    grid_sse.add_field(
        "node", "topographic__elevation", (2 * grid_sse.node_y - grid_sse.node_x) * S
    )
...
def grid_ese():
    ...
    grid_ese.add_field(
        "node", "topographic__elevation", (grid_ese.node_y - 2 * grid_ese.node_x) * S
    )
