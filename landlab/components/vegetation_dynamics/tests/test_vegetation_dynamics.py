...
def test_var_units(veg):
    ...
    assert veg.var_units("surface__evapotranspiration") == "mm/d"
    assert veg.var_units("surface__potential_evapotranspiration_rate") == "mm/d"
    assert veg.var_units("surface__potential_evapotranspiration_30day_mean") == "mm/d"
