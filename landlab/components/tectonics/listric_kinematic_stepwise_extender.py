...
class ListricKinematicStepwiseExtender(Component):
    ...
    def fault_plane_elev(self, dist_from_fault_trace):
        ...
        >>> topo = grid.add_zeros('topographic__elevation', at='node')
        >>> lke = ListricKinematicStepwiseExtender(grid, fault_location=10000.0)
