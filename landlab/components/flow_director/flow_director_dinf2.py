...
"""
flow_director_dinf2.py: provides the component FlowDirectorDINF2.
...
class FlowDirectorDINF2(_FlowDirectorToMany2):
    ...
    >>> from landlab.components import FlowDirectorDINF2
    ...
    >>> fd = FlowDirectorDINF2(mg, 'topographic__elevation')
    ...
    def __init__(self, grid, surface="topographic__elevation"):
        ...
        if self._is_Voroni:
            raise NotImplementedError(
                "FlowDirectorDINF2 is not implemented" " for irregular grids."
            )

        self.updated_boundary_conditions()

    def updated_boundary_conditions(self):
        """Method to update FlowDirectorDINF2 when boundary conditions change.
