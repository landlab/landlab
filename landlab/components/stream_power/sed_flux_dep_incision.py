...
class SedDepEroder(Component):
    ...
    def initialize(self, grid, params_file):
        ...
        mobility, i.e., it is not a function of bedrock resistance. If you
        ...
        REQUIRED:
            ...
            *Qc -> This input controls the sediment capacity used by the
                ...
                Alternatively, it can be another string denoting the grid
                field name in which a precalculated capacity is stored.
        ...
        be required:
            ...
            *If Qc=='MPM', these parameters may optionally be provided:
                ...
                C_MPM -> the prefactor in the MPM relation. Defaults to 1, as
                    ...
                    deposition begins. In cases where k_Q and k_w are not
                    known from real data, it is recommended these parameters
                    be tuned in preference to C.
        ...
        OPTIONAL:
            ...
            *slope_sensitive_threshold -> a boolean, defaults to FALSE.
                ...
                If this flag is set to TRUE, the critical threshold in the
                landscape is allowed to become slope sensitive as well, in
                order to be consistent with this equation. This modification
                was used by Hobley et al., 2011.
        ...
        if self.Qc == 'MPM':
            ...
            try:
                ...
                warnings.warn("a not supplied. Setting power on shear stress" +
                              " to 1.")
                self._a = 1.
            try:
        ...
        if self.Qc == 'MPM':
            ...
            if self.override_threshold:
                ...
                try:
                    ...
                    self.thresh = self.shields_crit*self.g*(
                        self.sed_density-self.fluid_density)*inputs.read_float(
                            'Dchar')
        ...
        if self.Qc == 'MPM':
            try:
                ...
                try:
                    ...
                    assert type(Dchar_if_used) is np.ndarray
                ...
                assert Dchar_if_used is None, (
                    "Trouble ahead... you can't provide Dchar both in the " +
                    "input file and as an array!")
            ...
            try:
                ...
                transport_capacities_thresh = (
                    variable_thresh*self.Qs_thresh_prefactor*runoff_rate**(
                        0.66667*self._b)*node_A**self.Qs_power_onAthresh)
            
            transport_capacity_prefactor_withA = (
                self.Qs_prefactor*runoff_rate**(0.6+self._b/15.)*node_A **
                self.Qs_power_onA)
            ...
            while 1:
                ...
                try:
                    ...
                    weave.inline(self.routing_code, [
                        ...
                        'dz', 'cell_areas', 'dt_this_step', 'flow_receiver'])
                except NameError:
