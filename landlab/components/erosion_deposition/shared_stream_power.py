...
from landlab.components.erosion_deposition.generalized_erosion_deposition import DEFAULT_MINIMUM_TIME_STEP
    ...
    **Additional References**
    ...
    def __init__(self,
        ...
        """Initialize the Shared Stream Power model.
                ...
                ...     mg, K_d=0.00001, K_t =.001, m_sp=0.5, n_sp=1.0, sp_crit=0
                ... )
    ...
    def update_runoff(self, new_r=1.0):
        ...
        self._grid.at_node["water__unit_flux_in"] = (self.r *
