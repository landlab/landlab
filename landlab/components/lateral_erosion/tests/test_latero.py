...
def test_variable_bedrock_K():
    ...
    # topography
    latero = LateralEroder(mg,latero_mech="UC", Kv=Kvar, solver="adaptive", alph=0.0, Kl_ratio=0.0)
...
def test_latero_steady_inlet():
    """
    test that steady inlet of drainage area and sediment functions
...
def test_latero_timevary_inlet():
    """
    test that time varying inlet function in lateral erosion component works. comparison
    to steady state solution and 
