...
class perron_nl_diffuse(object):
    '''
    ...
    def __init__(self, grid, input_stream):
        ...
        _top_list = range(nnodes-2*ncols+2,nnodes-ncols-2)
    ...
    def set_variables(self, grid):
        ...
        _mat_RHS[corenodesbyintIDs] = _mat_RHS[corenodesbyintIDs] + elev[_core_nodes] + _delta_t*(_func_on_z[_core_nodes] - _equ_RHS_calc_frag[_core_nodes])
