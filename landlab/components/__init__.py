...
COMPONENTS = [ChiFinder, LinearDiffuser,
              ...
              OverlandFlow, PotentialityFlowRouter, SurfaceFlowTransport,
              SinkFiller, StreamPowerEroder, FastscapeEroder, SedDepEroder,
              TransportLimitedEroder, SteepnessFinder, DetachmentLtdErosion]
