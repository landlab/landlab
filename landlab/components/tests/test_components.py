...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 19 13:17:27 2019
...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 29 10:39:19 2019
...
def test_component_metadata(Comp):
    if Comp.name not in ("ChannelProfiler", "DrainageDensity", "gFlex", "HackCalculator", "Lithology", "LithoLayers", "SoilMoisture", "Vegetation"):
        print(Comp.name)
