...
PAR = np.ones(1)*1124.98 # day 100 in 2010 on POWER_Point_Daily_20091231_20151230_039d81N_074d09W_LST.csv
increment_hour = 12 # or can use the below for loop
last_biomass = pd.DataFrame({'root_biomass':[3.0], 'stem_biomass':[2.0], 'leaf_biomass':[1.5], 'shoot_sys_width':[0.5]})
lai=3
min_temp = 1.85 # day 100 in POWER_Point_Daily_20100101_20191231_045d67N_0123d94W_LST.csv
max_temp = 10.51 # day 100 in POWER_Point_Daily_20100101_20191231_045d67N_0123d94W_LST.csv
...
print("Incremental PAR="+str(p.calculate_incremental_PAR(increment_hour, solar_elevation, PAR, day))) 
...
print("Absorbed Incremental PAR="+str(p.calculate_absorbed_incremental_PAR(increment_hour, solar_elevation, PAR, lai, day)))
...
print("Leaf assimilation="+str(p.calculate_leaf_assimilation(increment_hour, PAR, min_temp, max_temp)))
print("Photosynthesis="+str(p.photosynthesize(PAR, min_temp, max_temp, last_biomass, lai, day)))
