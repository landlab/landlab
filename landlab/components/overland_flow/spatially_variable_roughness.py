...
def spatially_variable_mannings_n(grid, water_depths='surface_water__depth', 
    ...
    water depths.
        ...
        index_flow_depth : float
            The flow depth above which it is assumed that 
            Manning's n is constant. (m)
        veg_drag_exponent : 
            An exponent related to vegetation drag effects, 
            which increases effective Manning's n at low flow conditions.      
    """
    ...
    grid.at_node['mannings_n'][locs_less] = ((min_mannings_n * (
                    grid.at_node['surface_water__depth'][locs_less] 
