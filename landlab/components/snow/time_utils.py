...
def get_current_datetime(start_datetime, time, time_units):
    ...
    # -----------------------------------------------------------
    datetime = get_datetime_from_time_since(start_datetime_obj, time, units=time_units)
...
def get_end_datetime(start_datetime, n_steps, time_units):
    start_datetime_obj = get_datetime_obj_from_one_str(start_datetime)
    end_datetime_obj = get_datetime_from_time_since(
        start_datetime_obj, n_steps, units=time_units
    )
...
#   pad_with_zeros()
# --------------------------------------------------------------------
def split_datetime_str(datetime_obj, datetime_sep=" ", ALL=False):
    # -----------------------------------------------
...
#   split_time_str()
# --------------------------------------------------------------------
def get_time_since_from_datetime(origin_datetime_obj, datetime_obj, units="days"):
    # -------------------------------------------------
...
#   get_time_since_from_datetime()
# --------------------------------------------------------------------
def get_datetime_from_time_since(origin_datetime_obj, time_since, units="days"):
    # For testing
    ...
    if delta is None:
        ...
        return msg  # origin_obj  TODO origin_obj not defined and msg is not used
...
#   convert_times_from_minutes_to_hhmm()
# ---------------------------------------------------------------------
def convert_times_from_datetime_to_minutes(times_datetime, origin_datetime_obj=None):
    ...
    for k in range(n_times):
        ...
        times_min[k] = get_time_since_from_datetime(
            origin_datetime_obj, datetime_obj, units="minutes"
        )
...
#   convert_times_from_datetime_to_minutes()
# ---------------------------------------------------------------------
def convert_times_from_minutes_to_datetime(times_min, origin_datetime_obj=None):
    if origin_datetime_obj is None:
        print("ERROR: origin_datetime_obj is required.")
        return
    ...
    for k in range(n_times):
        ...
        times_datetime[k] = get_datetime_from_time_since(
            origin_datetime_obj, time_since, units="minutes"
        )
