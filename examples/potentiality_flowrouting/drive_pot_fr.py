...
print(
    np.sum(mg.at_node["surface_water__discharge"].reshape((nrows, ncols)), axis=0) / 3.
)
...
print(
    "water in, water out: ",
    np.sum(mg.at_node["water__unit_flux_in"][mg.core_nodes]),
    np.sum(mg.at_node["surface_water__discharge"][mg.boundary_nodes]),
)
print(
    -np.sum(mg.at_node["surface_water__discharge"][mg.boundary_nodes])
...
print(
    ...
    / mg.at_node["water__unit_flux_in"][0]
)
