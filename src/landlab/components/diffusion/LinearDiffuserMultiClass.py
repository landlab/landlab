...
class LinearDiffuser(Component):
    ...
    **Additional References**
    ...
    def _spread_mass_between_classes(self):
        ...
        # Downwind links at node
        outlinks_at_node = self.grid.link_at_node_is_downwind(tgrad)

        # Map grain mass from upwind node to link
        ...
        # Correct flux based on class fractions
        ...
        # Sum all outfluxes per node to check if transport rate is over the mass
        ...
        # Sum flux across classes at link
