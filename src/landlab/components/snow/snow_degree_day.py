...
class SnowDegreeDay(Component):
    ...
    rain_snow_temp: float, optional
        Temperature threshold for precipitation occurs as rain and snow with
    ...
    def __init__(
        self, grid, c0=2.0, threshold_temp=0.0, rho_water=1000.0, rain_snow_temp=1.0
    ):
    ...
    def calc_precip_snow(precip_rate, air_temp, rain_snow_temp):
        ...
        rain_snow_temp: float
            Temperature threshold below which precipitation falls as snow [deg_C].
        """
