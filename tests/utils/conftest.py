...
def grid():
    ...
    mg.at_node['topographic__elevation'] = np.array([5,3,2,1,2,3,5,
                                                      7,4,1.5,3,3,4,7,
                                                      7.5,5,4,2,4,5,7.5,
                                                      7.5,5,3,5,6,6.5,9,
...
def nmgrid_f(grid):
    ...
    nmg_f.at_link["drainage_area"] = nmg_f.map_mean_of_link_nodes_to_link("drainage_area")
    return nmg_f
...
def nmgrid_c(grid):
    ...
    nmg_c.at_link["drainage_area"] = nmg_c.map_mean_of_link_nodes_to_link("drainage_area")
    return nmg_c
