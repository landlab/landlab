...
def test_xy_of_node_rect_horizontal(n_rows, n_cols):
    expected = {
        ...
        (1, 4): ([0.0, 1.0, 2.0, 3.0], [0.0, 0.0, 0.0, 0.0]),
        (3, 3): (
            [0.0, 1.0, 2.0, 0.0, 1.07341707, 2.0, 0.0, 1.0, 2.0],
            [0.0, 0.0, 0.0, 0.749, 1.03337157, 1.251, 2.0, 2.0, 2.0],
        ),
        (3, 4): (
            [0.0, 1.0, 2.0, 3.0, 0.0, 1.07341707, 2.08195999, 3.0, 0.0, 1.0, 2.0, 3.0],
            [
                0.0,
                0.0,
                0.0,
        ...
        (4, 3): (
            [0.0, 1.0, 2.0, 0.0, 1.07341707, 2.0, 0.0, 1.08195999, 2.0, 0.0, 1.0, 2.0],
            [
                0.0,
                0.0,
                0.0,
