...
def test_accumulated_area_closes():
    ...
    fa3 = FlowDirAccPf(mg3, seperate_Hill_Flow=True, accumulateFlowHill=True,hill_flow_metric='Quinn')
    fa3.run_one_step()
...
def test_D8_metric():
    ...
    topographic__elevation = np.array([  0. ,   0. ,   0. ,   0. ,   0. ,  21. ,  10. ,   0. ,   0. ,
        31. ,  30.8,   0. ,   0. ,  32. ,  30.9,   0. ,   0. ,   0. ,
         0. ,   0. ])
    ...
    reciever = np.array([ 0,  1,  2,  3,  4,  1,  2,  7,  8,  6,  6, 11, 12, 14, 10, 15, 16,
       17, 18, 19])  
...
def test_flow_accumulator_properties():
    ...
    node_drainage_area = np.array([ 3.,  2.,  1.,  0.,  0.,  2.,  3.,  2.,  1.,  0.,  1.,  2.,  2.,
