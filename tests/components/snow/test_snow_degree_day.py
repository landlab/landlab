...
def test_create_fields():
    ...
    assert_almost_equal(grid.at_node['atmosphere_water__time_integral_snowfall_leq-volume_flux'], 0)
...
def test_assign_parameters():
    ...
    sm = SnowDegreeDay(grid, rho_snow=300, rho_H2O=1001, T_rain_snow=1.1)
    ...
    assert sm.density_ratio == 1001/300, 'wrong density_ratio'
...
def test_snow_accumulation():
    ...
    grid = RasterModelGrid((2, 2))
    grid.add_full('atmosphere_bottom_air__temperature', -2, at='node')
    grid.add_full("atmosphere_water__precipitation_leq-volume_flux", 0.001 / np.float64(8.64E4), at='node')
    ...
    assert_almost_equal(grid.at_node['snowpack__melt_volume_flux'], 0)
    assert_almost_equal(grid.at_node['atmosphere_water__time_integral_snowfall_leq-volume_flux'], 0.001)
    assert_almost_equal(grid.at_node['snowpack__time_integral_melt_volume_flux'], 0)
...
def test_snow_melt():
    ...
    assert_almost_equal(grid.at_node['snowpack__melt_volume_flux'], 0.005/np.float64(8.64E4), decimal=11)
    assert_almost_equal(grid.at_node['atmosphere_water__time_integral_snowfall_leq-volume_flux'], 0)
...
def test_snow_melt_accumulation():
    ...
    grid.add_full("atmosphere_water__precipitation_leq-volume_flux", 0.002 / np.float64(8.64E4), at='node')  # m
    grid.add_full('snowpack__liquid-equivalent_depth', 0.005)  # m
    ...
    assert_almost_equal(grid.at_node['snowpack__melt_volume_flux'], (1.5/1000)/np.float64(8.64E4), decimal=11)
    assert_almost_equal(grid.at_node['atmosphere_water__time_integral_snowfall_leq-volume_flux'], 2/1000)
    assert_almost_equal(grid.at_node['snowpack__time_integral_melt_volume_flux'], 1.5/1000)
...
def test_multiple_runs():
    ...
    assert_almost_equal(grid.at_node['snowpack__melt_volume_flux'], 0.002/np.float64(8.64E4), decimal=11)
    assert_almost_equal(grid.at_node['atmosphere_water__time_integral_snowfall_leq-volume_flux'], 0)
    ...
    grid.at_node["atmosphere_water__precipitation_leq-volume_flux"].fill(0.002/np.float64(8.64E4))
    sm.rho_snow = 500
    ...
    assert_almost_equal(grid.at_node['snowpack__depth'], 0.01)
    assert_almost_equal(grid.at_node['snowpack__melt_volume_flux'], 0)
    assert_almost_equal(grid.at_node['atmosphere_water__time_integral_snowfall_leq-volume_flux'], 0.002)
    assert_almost_equal(grid.at_node['snowpack__time_integral_melt_volume_flux'], 0.002)
    ...
    assert_almost_equal(grid.at_node['snowpack__melt_volume_flux'], (0.5/1000)/np.float64(8.64E4), decimal=11)
    assert_almost_equal(grid.at_node['atmosphere_water__time_integral_snowfall_leq-volume_flux'], 0.004)
    assert_almost_equal(grid.at_node['snowpack__time_integral_melt_volume_flux'], 0.0025)

    # check mass balance
    in_out = (grid.at_node['atmosphere_water__time_integral_snowfall_leq-volume_flux'] -
